<svelte:head>
    <title>Reset Password - PokeFolio</title>
    <meta name="description" content="Set your new PokeFolio password. Enter your new password to complete the reset process." />
</svelte:head>
